var app = new Vue({
  ...
  data: function () {
    return {
      ...
      source: '',
      editorThemes: [
        { label: '默认-亮色', value: 'base15-light' },
        { label: '双色调', value: 'duotone-light' },
      ...
      currentSize: '15px',
      sizeOption: [
        { label: '14 px', value: '14px', desc: '默认' },
        { label: '15 px', value: '15px', desc: '正常' },
        { label: '16 px', value: '16px', desc: '稍大' }
      ],
      currentTheme: 'default',
      themeOption: [
        { label: 'default', value: 'default', author: 'HeyRain'},
